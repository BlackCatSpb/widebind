...
9.194@10019 → 9.129@11417 → 9.097@11650 → 9.066@11883 → 9.034@12116 → 9.003@12349 → 8.974@12582 → 8.948@12815 → 8.926@13048 → 8.915@13281 → 8.891@13514 → 8.865@13747 → 8.842@13980 → 8.822@14213 → 8.804@14446 → 8.795@14679 → 8.787@14912 → 8.779@15145 → 8.770@15378 → 8.763@15611 → **8.756@15844**
...
| `best 17.pt` | 14446 | 8.8036 | |
| `best 18.pt` | 14679 | 8.7950 | |
| `best 19.pt` | 14912 | 8.7867 | |
| `best 20.pt` | 15145 | 8.7787 | |
| `best 21.pt` | 15378 | 8.7705 | |
| `best 22.pt` | 15378 | 8.7705 | Дубликат best 21 |
| `best 23.pt` | 15611 | 8.7626 | |
| `best 24.pt` | 15844 | 8.7556 | **ТЕКУЩИЙ BEST** (HTML: `best 24_15844_report.html`) |
...
### ✅ ФИКС ПРИМЕНЁН (коммит `eb1f851`)

**Что исправлено:**
- `core/bridge.py`: bridge_stream → persistent=True
- `scripts/train.py`: optimizer/scheduler restore из checkpoint
- `notebooks/colab.ipynb`: cell 8b восстанавливает state вместо fresh

**Результат restart'а с best 17@14446:**

| Шаг | CE | val_loss | Примечание |
|---|---|---|---|
| 14446 | — | 13.83 | Первый eval (холодный start) |
| 14465 | 9.34 | — | CE в норме |
| 14520 | 8.00 | — | CE восстановился за 74 шага |
| 14575 | 8.06 | — | Стабильно |
| 14630 | 9.09 | — | Нормальная флюктуация |
| **14679** | — | **8.795** | **НОВЫЙ BEST!** |

**Вердикт:** Фикс работает. CE восстановился за 74 шага. val=8.795 — лучше предыдущего best (8.804).
