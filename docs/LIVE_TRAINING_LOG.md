...
```
Step  | L1 entries | L2 entries | L3 births | L3 capacity
4675  | 25         | 17         | 1         | 1/8
...
- **Step 9000–12000:** val < 9.0, mat_gate > 0.4, L3 births > 10,000
- **Step 12000–15000:** val < 8.5 (цель), mat_gate > 0.5
- **Step 15000–20000:** val < 8.0, memory bank fully saturated
