...
| Метрика | Значение |
|---|---|
| Шаг сохранения best | **9087** (обучение продолжается; последний присланный сырой лог — step 8965, но best обновлён до 9087). Локальный `checkpoints/best.pt` = 9087 (свежий, проанализирован: WAKE-CANDIDATE). |
| val_loss / ppl | 9.4035 / ~12130 |
...
10.0216 (5126) → 9.9749 (5359) → 9.9283 (5592) → 9.8816 (5825) → 9.8366 (6058) → 9.7956 (6291) → 9.7516 (6524) → 9.7113 (6757) → 9.6820 (6990) → 9.6390 (7223) → *перестройка (7689=11.09, 7922=15.74)* → **9.5201 (8388) → 9.4821 (8621) → 9.4425 (8854) → 9.4035 (9087)** — новый best после прорыва.
...
⏳ *Сырой лог за 8965 → 9087+ ещё не прислан; зафиксирован новый best **9.4035@9087** (подтверждён analyze, отчёт `best_9087_report.html`).*
